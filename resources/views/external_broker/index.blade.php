...
<head>
  ...
  <link href="css/buyer-input-form.css" rel="stylesheet" type="text/css">
...
<body>
      ...
      <div class="buyer-input-form">
        <div class="w-form">
          <form id="email-form"  action='{{url("/buyer_request")}}' method='post'  enctype='multipart/form-data'>
            ...
            <label for="email" class="field-label">Phone</label><input type="number" class="input-fields w-input" maxlength="256" name="phone" data-name="Phone" id="phone" required="">
  ...
  <script src="js/buyer-input-form-b30044.js" type="text/javascript"></script>
