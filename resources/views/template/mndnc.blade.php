...
@section('content')
  <div>
    <form action="/send_mndnc" method="post">
      @csrf
    <div class="template-container w-container mt-4"><img src="images/jvtock-logo.png" width="150" alt="" class="image">
      ...
      <p class="paragraph parag-1">
        <span class="centered">NON-CIRCUMVENTION, NON-DISCLOSURE AND CONFIDENTIALITY AGREEMENT THIS AGREEMENT entered into on: <input Type='date' name="date_a" required /> is for the Professional Association and arrangement of Non-Circumvention, Non-Disclosure and Confidentiality between: JVTOCK Trading Corp. whose office is located at 1601 5611 goring st Burnaby British Columbia,Canada
        <br><br>And:<br><br> <input type="text" name="client_name" class="form-field w-input" placeholder="Client Name" required/>
        <br>whose principal place of business is at:
        <br><br><input type="text" name="address" class="form-field w-input" placeholder="Client Address" required />
