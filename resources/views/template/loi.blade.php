  ...
  <div>
    ...
    <div class="template-container w-container"><img src="images/jvtock-logo.png" width="150" alt="" class="image">
      ...
      <p class="paragraph parag-1">
        ...
        <br><br>On behalf of <input type="text" name="buyer_info" required/><br>(the &quot;Purchaser&quot;)
        <br>‍<br><strong>- AND -
          <br>‍<br></strong>
          ...
          <br><input class="mt-3" id="supplier_details" type="text" name="supplier_info" required/><br><br>(the &quot;Seller&quot;).
        </span><br><br><br></p>
      <p class="paragraph"><span class="centered"> <strong>BACKGROUND:<br><br></strong>
        ...
        <br>
      </strong>4.  <input type="text" name="transaction_details" required/><br>
        <br>5. <strong class="bold">Purchase Price<br>
        </strong>6.  <input type="text" name="purchase_price" required/><br>
